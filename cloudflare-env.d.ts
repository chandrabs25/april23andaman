...
/* ------------------------------------------------------------------ */
/* 👇 NEW — give TS something it can `import type { CloudflareEnv }`  */
/* ------------------------------------------------------------------ */
...
/* optional: merge into the global scope for libraries
   that expect a global CloudflareEnv (safe to omit if you don’t need it)
*/
declare global {
