...
import {
    ...
    Moon, // For Sunset at Chidiyatapu (can use Sunset icon too)
...
export default function AndamanPackagePage3D2N() {
    ...
    // Placeholder image paths - Add/Update as needed for 3-day tour
    const placeholderImages = {
        ...
        rossIsland: '/images/ross-island.jpg', // Image for Ross/North Bay day
        portBlairMarket: '/images/port-blair-market.jpg', // Image for departure day
        ...
        highlightNorthBay: '/images/north-bay.jpg', // Image for Ross/North Bay highlight
        highlightChidiyatapu: '/images/chidiyatapu-sunset.jpg', // Image for Chidiyatapu highlight
        expectHistorical: '/images/historical-sites.jpg', // Reusing expect images
        expectIsland: '/images/island-hopping.jpg', // New expect image concept
        expectNature: '/images/nature-sunset.jpg', // New expect image concept
        diningSeafood: '/images/seafood.jpg',
        diningLocal: '/images/local-cuisine.jpg',
        galleryCellularJail: '/images/gallery-cellular-jail.jpg',
        galleryCorbynsCove: '/images/gallery-corbyns-cove.jpg',
    ...
    return (
        ...
        <main className="bg-white min-h-screen">
            ...
            <div className="relative">
                <div className="relative h-[500px] w-full">
                    <Image
                        ...
                        alt="Andaman Islands scenery with turquoise water"
                        fill
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10 text-white z-10">
                    ...
                    <p className="text-base sm:text-lg md:text-xl text-white/90 max-w-3xl mb-5 sm:mb-6 drop-shadow-md">
                        Explore Port Blair: historic sites, stunning beaches, island hopping to Ross & North Bay, and vibrant marine life in this exclusive 3-day package for 2 adults.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white rounded-2xl shadow-lg p-6 text-center transition-all duration-300 hover:shadow-xl hover:transform hover:-translate-y-2 border border-gray-100">
                            ...
                            <p className="text-gray-600">
                                We ensure all cabs are sanitized before every trip for a safe holiday experience.
                            </p>
                        </div>
                        <div className="bg-white rounded-2xl shadow-lg p-6 text-center transition-all duration-300 hover:shadow-xl hover:transform hover:-translate-y-2 border border-gray-100">
                            <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6">
                            ...
                            <p className="text-gray-600">
                                We personally visit hotels before recommending them to our guests in the Andamans.
                            </p>
                        </div>
                        <div className="bg-white rounded-2xl shadow-lg p-6 text-center transition-all duration-300 hover:shadow-xl hover:transform hover:-translate-y-2 border border-gray-100">
                            <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6">
                            ...
                            <p className="text-gray-600">
                                Enjoy a safe experience with our verified partners for all activities.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            {/* Itinerary Section with Images - Matched sample styling */}
                        ...
                        <div className="md:flex">
                            ...
                            <div className="p-6 md:p-8 md:w-1/2">
                                ...
                                <div className="space-y-4 text-gray-700">
                                    <p>
                                        Arrive at Port Blair airport, meet our representative, and transfer to your hotel. Post-lunch, visit the historic Cellular Jail (Kala Paani), a poignant reminder of India's freedom struggle.
                                    </p>
                                    <p>
                                        Next, head to Corbyn's Cove Beach, ideal for relaxation or optional water sports like jet skiing and speed boating (own cost).
                                    </p>
                                    <p>
                                        Conclude the day with the captivating Light and Sound Show at Cellular Jail, bringing history to life. Return to your hotel.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg overflow-hidden mb-12 border border-gray-100">
                        <div className="md:flex flex-row-reverse">
                            <div className="md:w-1/2 relative group">
                                <div className="h-64 md:h-full relative">
                                    <Image
                                        src={placeholderImages.rossIsland}
                            ...
                            <div className="p-6 md:p-8 md:w-1/2">
                                <h3 className="flex items-center text-xl font-semibold text-gray-800 mb-4">
                                    <Anchor className="mr-2 flex-shrink-0 text-gray-500" size={20} /> {/* Icon for island hopping */}
                                    <span>Day 2: Ross Island, North Bay & Chidiyatapu Sunset</span>
                                </h3>
                                <div className="space-y-4 text-gray-700">
                                    <p>
                                        After breakfast, take a boat trip to Ross Island, the former British administrative headquarters, exploring its ruins amidst nature. Spot deer and peacocks.
                                    </p>
                                    <p>
                                        Proceed to North Bay Island (Coral Island) for exciting underwater views. Witness vibrant coral reefs and marine life (snorkeling/glass-bottom boat optional, own cost).
                                    </p>
                                    <p>
                                        Return to Port Blair jetty. Later, visit Chidiyatapu (Bird Island) and Mundapahad Beach for a breathtaking sunset view.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                        <div className="md:flex">
                            <div className="md:w-1/2 relative group">
                                <div className="h-64 md:h-full relative">
                                    <Image
                                        src={placeholderImages.portBlairMarket}
                            ...
                            <div className="p-6 md:p-8 md:w-1/2">
                                <h3 className="flex items-center text-xl font-semibold text-gray-800 mb-4">
                                    ...
                                    <span>Day 3: Departure with Sweet Memories</span>
                                </h3>
                                <div className="space-y-4 text-gray-700">
                                    <p>
                                        Enjoy breakfast at the hotel. Depending on your flight schedule, you may have time for last-minute souvenir shopping.
                                    </p>
                                    <p>
                                        Proceed to Veer Savarkar International Airport for your departure, taking home cherished memories of your Port Blair adventure.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105 border border-gray-100 group">
                            <div className="h-48 relative">
                                ...
                                <div className="absolute bottom-3 left-3 text-white font-semibold drop-shadow">Cellular Jail Visit</div>
                            </div>
                            <div className="p-5">
                                <p className="text-gray-600 text-sm">
                                    Explore historic Cellular Jail & witness the moving Light and Sound show.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105 border border-gray-100 group">
                            ...
                            <div className="p-5">
                                <p className="text-gray-600 text-sm">
                                    Relax at this scenic beach and enjoy optional water sports activities.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105 border border-gray-100 group">
                            <div className="h-48 relative">
                                <Image src={placeholderImages.highlightNorthBay} alt="Ross and North Bay Islands" fill style={{ objectFit: 'cover' }} className="transition-transform duration-500 group-hover:scale-110" />
                                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                                <div className="absolute bottom-3 left-3 text-white font-semibold drop-shadow">Ross & North Bay Trip</div>
                            </div>
                            <div className="p-5">
                                <p className="text-gray-600 text-sm">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105 border border-gray-100 group">
                            ...
                            <div className="p-5">
                                <p className="text-gray-600 text-sm">
                                    Visit the bird sanctuary and enjoy a breathtaking sunset at Mundapahad Beach.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-16 md:py-24 bg-gray-50" id="accommodation">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">
                        Choose from selected hotels in Port Blair for 2 nights (based on 2 Adults).
                    </p>
                    ...
                    <div className="mt-8">
                        ...
                        {activeTab === 'luxury' && (
                            <div className="bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl border border-gray-100">
                                <div className="md:flex">
                                    <div className="md:w-1/3 h-64 md:h-auto relative group">
                                        <Image src={placeholderImages.hotelLuxury} alt="Sea Shell or similar" fill style={{ objectFit: 'cover' }} className="transition-transform duration-500 group-hover:scale-110" />
                                    </div>
                                    <div className="p-6 md:p-8 md:w-2/3">
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                            ...
                            <div className="p-5"> <h3 className="text-xl font-semibold mb-3 text-gray-800">Historical Exploration</h3> <p className="text-gray-600 text-sm">Delve into India's past at Cellular Jail and Ross Island's colonial ruins.</p> </div>
                        </div>
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                            <div className="h-48 relative"> <Image src={placeholderImages.expectIsland} alt="Island Hopping" fill style={{ objectFit: 'cover' }} /> </div>
                            <div className="p-5"> <h3 className="text-xl font-semibold mb-3 text-gray-800">Island Adventures</h3> <p className="text-gray-600 text-sm">Enjoy boat trips to Ross & North Bay, relax at Corbyn's Cove, explore coral reefs.</p> </div>
                        </div>
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                            <div className="h-48 relative"> <Image src={placeholderImages.expectNature} alt="Nature and Sunset" fill style={{ objectFit: 'cover' }} /> </div>
                            <div className="p-5"> <h3 className="text-xl font-semibold mb-3 text-gray-800">Nature & Scenic Beauty</h3> <p className="text-gray-600 text-sm">Visit Chidiyatapu bird sanctuary and witness stunning Andaman sunsets.</p> </div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 md:py-24 bg-gray-50" id="details">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">
                        What's included in your 2 Nights / 3 Days package and what's not.
                    </p>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-gray-100">
                            ...
                            <ul className="space-y-3 text-gray-700 text-sm"> {/* Reduced font size */}
                                {[
                                    'Accommodation: 2 Nights in Port Blair (selected category) with Breakfast.',
                                    'Transfers: Private A/C Cab (Airport Pick Up/Drop, Hotel to Sightseeing spots per itinerary).',
                                    'Tickets: Cellular Jail Entry & Light/Sound Show.',
                                    'Boat Tickets: Port Blair <> Ross Island <> North Bay Island <> Port Blair.',
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-gray-100">
                            ...
                            <ul className="space-y-3 text-gray-700 text-sm"> {/* Reduced font size */}
                                {[
                                    'Flight Tickets.',
                                    'Lunch and Dinner.',
                                    'Water sports activities (e.g., Jet Ski, Snorkeling) & Camera fees.',
                                    'Anything not explicitly mentioned in inclusions.',
                                    'Expenses due to unforeseen circumstances (delays, etc.).',
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-gray-100 max-w-3xl mx-auto">
                        <p className="text-gray-700 mb-4">
                            Your package includes complimentary breakfast at the hotel.
                        </p>
                        <p className="text-gray-700">
                            Explore Port Blair's diverse food scene for lunch and dinner (not included). From local eateries to multi-cuisine restaurants, find options for every budget. Seafood is highly recommended!
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
                        {[
                            ...
                            { src: placeholderImages.galleryCorbynsCove, alt: 'Corbyn\'s Cove Beach' },
                            { src: placeholderImages.galleryRossIsland, alt: 'Ross Island Ruins' },
                            { src: placeholderImages.galleryNorthBayCoral, alt: 'North Bay Island Corals' },
                            { src: placeholderImages.galleryChidiyatapu, alt: 'Chidiyatapu Beach / Sunset' },
                            { src: placeholderImages.galleryPortBlairView, alt: 'Port Blair Scenery' },
                            ...
                            <div key={index} className="relative h-48 md:h-64 rounded-2xl overflow-hidden group">
                                ...
                                {/* Removed text overlay from gallery images to match Sample A */}
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="relative py-20 md:py-32 bg-gray-100" id="contact">
                <div className="container mx-auto px-4 relative z-10 text-center">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6 drop-shadow-sm">
                        Ready for Your 3-Day Port Blair Getaway?
                    </h2>
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-10 drop-shadow-sm">
                        Contact our travel experts today to customize and book your perfect short Andaman adventure.
                    </p>
