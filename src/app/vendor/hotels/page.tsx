                ...
                <tr key={hotel.service_id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-sm">
                    ...
                    <div className="flex items-center space-x-3">
                        {/* Edit Button - ADD THIS LINK */}
                        <Link href={`/hotels/${hotel.service_id}/edit`} className="text-blue-600 hover:text-blue-800 hover:underline p-1" title="Edit Hotel Details">
                            <Edit size={18} />
                        </Link>
                        {/* Delete Button */}
                        <button
